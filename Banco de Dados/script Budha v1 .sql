...
create table fornecedor (
  ...
  rua_fornecedor varchar(120),
  bairro_fornecedor varchar(120),
  complemento_fornecedor varchar(120),
  cep_fornecedor varchar (45),
  tipoProduto_fornecedor varchar(45),
  numero_fornecedor varchar(45),
...
create table condicional_produto (
  pk_condicional_produto int primary key auto_increment,
  fk_produto int not null,
  fk_condicional int not null,
